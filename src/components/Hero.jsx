    ...
    >
      <div className="wrapper bg-[#081730] flex items-center justify-between px-[5rem] rounded-b-[5rem] w-[100%] h-[35rem] relative z-[3]">
        ...
        <div className="headings flex flex-col items-start justify-center h-[100%] text-[3rem]">
          <span style={color}><b>PENAFY</b></span>{" "}
          <span>
            <b >Bringing the In-store Feel Online</b>
          </span>
          <span className="text-[15px] text-[#525D6E]" style={color}>
            Allowing customers to virtually test out products
            <br />
            and accessories before they buy.
          </span>
          {/* download ads */}
          <div>
